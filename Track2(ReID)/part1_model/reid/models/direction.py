...
class Direction_ResNet(nn.Module):

    def __init__(self, block, layers, num_classes, num_features):
        super(Direction_ResNet, self).__init__()
...
def direction_resnet50(pretrained=False, **kwargs):
    model = Direction_ResNet(Bottleneck, [3, 4, 6, 3], **kwargs)
    return model
