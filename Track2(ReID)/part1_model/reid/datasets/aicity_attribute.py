...
from ..utils.data import Attribute_Dataset
from ..utils.osutils import mkdir_if_missing
from ..utils.serialization import write_json


class Aicity_Attribute(Attribute_Dataset):
    url = 'https://drive.google.com/file/d/0B8-rUzbwVRk0c054eEozWG9COHM/view'
    md5 = '65005ab7d12ec1c44de4eeafe813e68a'

    def __init__(self, root, split_id=0, num_val=100, download=True):
        super(Aicity_Attribute, self).__init__(root, split_id=split_id)
    ...
    def download(self):
        ...
        meta = {'name': 'Aicity_Attribute', 'shot': 'multiple', 'num_cameras': 41,
