...
class New_Complete_Aicity_Car196(Dataset):
    ...
    def download(self):
        ...
        meta = {'name': 'New_Complete_Aicity_Car196', 'shot': 'multiple', 'num_cameras': 41,
